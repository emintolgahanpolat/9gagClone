...
module.exports = function(passport) {
    ...
    function isUsernameTaken(username) {
        ...
        db.users.count({ username: regexp })
            .then((count) => {
            if (count > 0) {
            return true;
        }
                ...
                if (!req.user) {
                    User.findOne({ 'email' :  email }, function(err, user) {
                        ...
                        if (user) {
                            ...
                            newUser.username= email.substring(0, email.indexOf("@")).toLowerCase();
                            newUser.email    = email;
                ...
                if (!req.user) {
                    ...
                    User.findOne({ 'email' : profile.emails[0].value }, function(err, user) {
                        ...
                        if (user) {
                            ...
                            newUser.username=profile.emails[0].value.substring(0, profile.emails[0].value.indexOf("@")).toLowerCase();
